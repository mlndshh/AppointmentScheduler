...
<div class="demo-layout mdl-layout mdl-js-layout mdl-layout--fixed-drawer mdl-layout--fixed-header">
    <header class="demo-header mdl-layout__header mdl-color--grey-100 mdl-color-text--grey-600">
        <div class="mdl-layout__header-row">
            <span class="mdl-layout-title">Templates</span>
    ...
    <main class="mdl-layout__content mdl-color--grey-100">
        <div class="mdl-grid demo-content">
            ...
            $tempsql="SELECT Name,TemplateID FROM templatemaster";
            $tempres= $conn->query($tempsql);
           while( $temparr=$tempres->fetch_assoc() ){
           ?>

               <div class="demo-card-square mdl-card mdl-shadow--2dp">
                   <div class="mdl-card__title mdl-card--expand">
                       <h2 class="mdl-card__title-text"><?php  echo $temparr["Name"];
                        $templateid = $temparr["TemplateID"];
                       ?></h2>
                   </div>
                   <div class="mdl-card__supporting-text">
                       <?php
                       $tempsql1="SELECT Caption FROM templatedetails WHERE TemplateID = $templateid";
                       $tempres1= $conn->query($tempsql1);
                       echo "<ul>";
                       while( $temparr1=$tempres1->fetch_assoc() ){
                           echo "<li>".$temparr1["Caption"]."</li>";
