    ...
    <div class="demo-layout mdl-layout mdl-js-layout mdl-layout--fixed-drawer mdl-layout--fixed-header">
      <header class="demo-header mdl-layout__header mdl-color--grey-100 mdl-color-text--grey-600">
        <div class="mdl-layout__header-row">
          <span class="mdl-layout-title">View Visits</span>
      ...
      <main class="mdl-layout__content mdl-color--grey-100">
        ...
        <form name = "date_select" method="GET" action="ViewVisits.php">
        ...
        <div>
          <?php
              ...
              $sql="SELECT * from visitmaster where Date = '$tdate'";
				   ...
				   echo "<tr><th>Visit ID</th><th>PatientID</th><th>PatientName</th><th>Date</th><th>Time</th><th>Remarks</th><th>View Info</th></tr>";
                          
                    echo "<form name='ViewAppointments' method='_GET' action='ViewVisitInfo.php'>";  
                    ...
                    while ($row=$result->fetch_assoc()) {  
							   ...
							   echo "<td>". $namerow['Name']. "</td>";
							   echo "<td>". $row['Date']. "</td>";
							   echo "<td>". $row['Time']. "</td>";
							   echo "<td>". $row['Remarks']. "</td>";
							   echo "<td><button  class='mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect' type='Submit' name='Visit' value= $vid id='ViewAppt'><span class='mdl-chip__text'>VIEW INFO</span>
              </button></td>";
                       }
                }
                echo "</form>";
