      ...
      <main class="mdl-layout__content mdl-color--grey-100">
	    ...
	    <form id="senddata" method="POST">
			...
			<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
				...
				<label class="mdl-textfield__label" for="Remarks">Patient Remarks...</label>         
			</div>
			<br>
			Date:
			<br>
			...
			<br>
			<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
				<input class="mdl-textfield__input" type="text" id="RefDocName" name="RefDocName">
        ...
        <?php
          ...
          if (isset($_POST["submit"]))
          {
			...
			$appsql="insert into appointment values($appid,$pid,'$name','$date','$time','$refdocname','$appremarks')";
			if ($conn->query($appsql) === TRUE) {
				echo "Appointment Added.<br>";
            } 
			else {
				echo "Error: " . $appsql . "<br>" . $conn->error;
              }
